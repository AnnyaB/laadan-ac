...
<p align="center">
  <img src="figures/paper/supplementary/trajectory_animation.gif" width="80%" alt="LAADAN-AC fixed-checkpoint trajectory illustration">
</p>
...
<p align="center">
  <img src="figures/paper/main/fig2_icu_fixed_schedule_comparison.png" width="96%" alt="ICU-Sepsis fixed-schedule comparison">
</p>
...
<p align="center">
  <img src="figures/paper/main/fig3_paired_training_vs_posthoc.png" width="72%" alt="Paired LAADAN-AC and post-hoc masked VOAC comparison">
</p>
...
<p align="center">
  <img src="figures/paper/main/fig4_full_component_ablation.png" width="84%" alt="LAADAN-AC component ablation">
</p>
...
<p align="center">
  <img src="figures/paper/appendix/figA1_cross_source_portability.png" width="86%" alt="Cross-source portability comparison">
</p>
...
python scripts/run_fixed_schedule_ablations.py \
  ...
  --output-root results/main/icu_sepsis \
...
python scripts/run_fixed_schedule_safety_diagnostics.py \
  --data-dir data/icu_sepsis \
  --results-root results/main/icu_sepsis \
  --output-dir results/main/icu_sepsis/safety_diagnostics \
...
Then validate the frozen results and implementation:


```bash
python scripts/validate_fixed_schedule_results.py \
  --root results/main/icu_sepsis \
  --data-dir data/icu_sepsis \
  --ablations full \
  --skip-figures

python scripts/validate_fixed_schedule_results.py \
  --root results/main/eicu_demo \
...
The evidence is under [`results/main/`](results/main/). Each trained seed directory contains the saved model, training history, final metrics, and provenance where applicable. The release records the checkpoint rule, evaluated epoch, environment, and input-data hashes needed to audit the reported results.
